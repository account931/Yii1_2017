...
#Gii is  enabled  by  adding array text  to config->main.php;

#/views/site/pages =>  pages  rendered  in main (i.e about, addmine);

#create horizontal top menu =>go to [ protected/views/layouts/main.php] + add [array('label'=>'My_add', 'url'=>array('site/myadd')),]
